...
for model in model_dict:
    ...
    for ii in range(n_runs): 
        ...
        one_df.to_csv("lstmfcn_aug10_1_eval.csv")
        # Save predictions and test values:
        one_df = pd.concat(dfs_pred)
        one_df.to_csv("lstmfcn_aug10_1_pred.csv")
...
for model in model_dict:
    ...
    for ii in range(n_runs): 
        ...
        # Save evaluation metrics
        one_df = pd.concat(dfs_eval)
        one_df.to_csv("lstmfcn_aug10_2_eval.csv")
        # Save predictions and test values:
        one_df = pd.concat(dfs_pred)
        one_df.to_csv("lstmfcn_aug10_2_pred.csv")
...
for model in model_dict:
    ...
    for ii in range(n_runs): 
        ...
        # Save evaluation metrics
        one_df = pd.concat(dfs_eval)
        one_df.to_csv("lstmfcn_aug10_3_eval.csv")
        # Save predictions and test values:
        one_df = pd.concat(dfs_pred)
        one_df.to_csv("lstmfcn_aug10_3_pred.csv")
...
for model in model_dict:
    ...
    for ii in range(n_runs): 
        ...
        # Save evaluation metrics
        one_df = pd.concat(dfs_eval)
        one_df.to_csv("lstmfcn_aug10_4_eval.csv")
        # Save predictions and test values:
        one_df = pd.concat(dfs_pred)
        one_df.to_csv("lstmfcn_aug10_4_pred.csv")
...
for model in model_dict:
    ...
    for ii in range(n_runs): 
        ...
        # Save evaluation metrics
        one_df = pd.concat(dfs_eval)
        one_df.to_csv("lstmfcn_aug10_5_eval.csv")
        # Save predictions and test values:
        one_df = pd.concat(dfs_pred)
        one_df.to_csv("lstmfcn_aug10_5_pred.csv")
...
for model in model_dict:
    ...
    for ii in range(n_runs): 
        ...
        # Save evaluation metrics
        one_df = pd.concat(dfs_eval)
        one_df.to_csv("lstmfcn_aug10_6_eval.csv")
        # Save predictions and test values:
        one_df = pd.concat(dfs_pred)
        one_df.to_csv("lstmfcn_aug10_6_pred.csv")
